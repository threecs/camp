...
/* Students:
 * Create a migration file that inserts an email column into your table. 
 * Make it so that it cannot be a null value. Add in emails to the users
 * In server.js
 *
 * Good Luck!
 * ==================================================================== */
...
.then(function(){
	...
	.then(function(user){
		return models.Fandom.findOne({where:{fanpage:"Twin Peaks"}})
...
app.get('/:fandom/users', function(req, res){
	...
	models.Fandom.findOne({where: { fanpage: fandom} })
